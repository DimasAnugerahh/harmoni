            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <nav class="sidebar sidebar-offcanvas" id="sidebar">
                    <ul class="nav">
                            ...
                            <div class="collapse" id="ui-basic">
                                <ul class="nav flex-column sub-menu">
                                    <li class="nav-item"> <a class="nav-link"
                                            href="/tables">RKA</a></li>
                                    <li class="nav-item"> <a class="nav-link"
                                            href="../../pages/ui-features/dropdowns.html">Input Realisasi</a></li>
                                    <li class="nav-item"> <a class="nav-link"
                        ...
                        <li class="nav-item">
                            ...
                            <div class="collapse" id="non-cid">
                                <ul class="nav flex-column sub-menu">
                                    ...
                                    <li class="nav-item"> <a class="nav-link"
                                            href="../../pages/ui-features/dropdowns.html">Input Realisasi</a>
                                    </li>
                                    <li class="nav-item"> <a class="nav-link"
                                            href="../../pages/ui-features/typography.html">Typography</a></li>
                                </ul>
                        ...
                        <br>
                        <li class="nav-item">
                            <a class="nav-link" data-toggle="collapse" href="#my-account" aria-expanded="false" aria-controls="my-account">
                                <i class="icon-layout menu-icon"></i>
                            ...
                            <div class="collapse" id="my-account">
                                <ul class="nav flex-column sub-menu">
                                    ...
                                    <li class="nav-item"> <a class="nav-link" href="../../pages/ui-features/dropdowns.html">Input Realisasi</a>
                                    </li>
